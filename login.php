...
if($_POST){
    ...
    if($entidadUsuario->verificarClave($clave, $entidadUsuario->clave)){
        //Si es correcto creamos una variable de session llamada nombre y tenga el valor de "Ana Valle"
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST">
                                        <?php if(isset($msg)): //Texto de alerta ?>
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="txtClave" name="txtClave" placeholder="Contraseña" value="admin123">
                                        </div>
                                        <div class="form-group">
